...
//
// Browsing lives in Library, not here. The poster grid, client-side title search
// and Grid/Table toggle this screen once carried moved to Library.tsx (Movies/
// Series only) — Tag keeps all three mode tabs because Adult's tag CRUD has no
// other home, and Adult is out of scope for that move.
