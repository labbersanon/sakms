          ...
          <For each={rows()}>
            {(row, i) => {
              ...
              return (
                ...
                //   it does not dominate the chip. Chips use bg-surface/70 so
                ...
                <div class="space-y-2">
                  ...
                  <Show when={row.field === "tag"}>
                    ...
                    >
                      <For each={row.values}>
                        {(tag) => (
                          <span class="inline-flex max-w-full items-center gap-1 rounded border border-border bg-surface/70 px-2 py-0.5 text-sm text-fg backdrop-blur-sm">
