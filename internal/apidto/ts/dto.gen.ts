...
export interface AvailabilityDiagnostics {
   ...
   */
  matchedReleaseCount: number /* int */;
  /**
 ...
 */
export interface MoveModeRequest {
  /**
 ...
 */
export interface AdultSceneCandidate {
  box: string;
  sceneId: string;
  title: string;
  studio?: string;
 ...
 */
export interface AdultSceneSearchResponse {
  items: AdultSceneCandidate[];
  errors?: string[];
}
/**
 ...
 */
export interface RecentlyAppliedEntry {
  undoId: number /* int64 */;
  proposalId: number /* int64 */;
  mode: string;
  appliedAt: string;
