...
afterEach(() => {
  ...
  vi.unstubAllGlobals();
  vi.restoreAllMocks();
  // Tag itself no longer touches localStorage (the grid view and its persisted
  // Grid/Table toggle moved to Library), but clearing it keeps these tests
  // independent of whatever another suite left behind.
